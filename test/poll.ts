...
describe ("Polling", () => {
    ...
    describe("Vote", () => {
        ...
        it("Should revert if rating is not valid", async function(){
            ...
            await expect(poll.connect(signer3).Vote(1, 10)).to.be.revertedWith("invalid Rating");
        });
        ...
        it("Should revert if duration for vote has exceeded", async function(){
            ...
            await poll.connect(signer1).createVote("Manager", 0, "https://source.unsplash.com/mkTqZN1NzhY/640x960", "Obi Peters or Tinubu or Atiku");
